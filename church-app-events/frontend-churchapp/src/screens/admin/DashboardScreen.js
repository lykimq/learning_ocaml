...
import ManageMediaScreen from './ManageMediaScreen';
import ManageHomeGroupScreen from './ManageHomeGroupScreen';
import ManageServingScreen from './ManageServingScreen';
import ManageGivingScreen from './ManageGivingScreen';
    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.scrollView}>
        <View style={styles.cardContainer}>
          ...
          <Card
            style={styles.card}
            onPress={() => navigation.navigate ('ManageHomeGroupScreen')}
          >
            <ImageBackground
          ...
          <Card
            style={styles.card}
            onPress={() => navigation.navigate ('ManageGivingScreen')}
          >
            <ImageBackground
