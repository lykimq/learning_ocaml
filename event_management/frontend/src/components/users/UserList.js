...
const UserList = () => {
  ...
  const handleSubmit = async e => {
    e.preventDefault ();
    const url = isEditing
      ? `${process.env.REACT_APP_BACKEND_URL}/users/${editUserId}/edit`
    ...
    async () => {
      try {
        const response = await fetch (
          `${process.env.REACT_APP_BACKEND_URL}/users/admin/list?sort_by=${sortBy}`
        );
        if (!response.ok) {
      ...
      <div className="registration-page">
        ...
        <div className="container-table">
          <div className="toggle-user-list">
            ...
            <p className="app-description">
              You can choose to show or hide the list of registered users.
            </p>
            <button
